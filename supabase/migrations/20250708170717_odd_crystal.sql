/*
  ...
  1. New Tables
    ...
    - `user_settings` - User application preferences and settings
    - `scans` - Skin scan results and analysis data
  ...
  3. Features
    - Automatic timestamp handling with triggers
...
-- Add membership_type constraint if it doesn't exist
DO $$
BEGIN
  IF NOT EXISTS (
