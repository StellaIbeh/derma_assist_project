...
import { Camera, MessageCircle, History, TrendingUp, Heart, Shield, Brain, Users, Award, ChevronRight, Info, TriangleAlert as AlertTriangle } from 'lucide-react-native';
        ...
        <View style={styles.section}>
          ...
          <ScrollView horizontal showsHorizontalScrollIndicator={false} style={styles.educationScroll}>
            {educationalContent.map((content, index) => (
              <TouchableOpacity key={index} style={styles.educationCard} activeOpacity={0.8}>
